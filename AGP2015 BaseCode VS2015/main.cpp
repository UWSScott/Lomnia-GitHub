...
void init(void)
{
	...
	Game_Hub_Prefabs.push_back(Prefab(shaderProgram, Resource_Managment->LoadObject("Models/House_Player.obj"), Resource_Managment->LoadTexture("Models/Textures/House_002.bmp"), glm::vec3(2.5, 2.2, 2.5), glm::vec3(47.29, 2.54, 82.97), -123.7, glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0)));
	Game_Hub_Prefabs.push_back(Prefab(shaderProgram, Resource_Managment->LoadObject("Models/House_Player.obj"), Resource_Managment->LoadTexture("Models/Textures/House_002.bmp"), glm::vec3(2.5, 2.2, 2.5), glm::vec3(-15.6, 2.54, -87.2), -123.7, glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 0.0, 0.0)));
...
void update(void) {
	...
	cout << " arn pos: " << character->position.x << "  y: " << character->position.y << " z: " << character->position.z << " rotation: " << character->rotation << " incombat: " << character->inCombat << endl;
