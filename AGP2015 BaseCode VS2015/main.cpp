...
void update(void) {
	...
	//cout << Game_Hub_Characters[3]->Collider->getX() << "  " << Game_Hub_Characters[3]->Collider->getZ() << endl;
	//cout << Game_Hub_Characters[8]->Collider->getX() << "  " << Game_Hub_Characters[8]->Collider->getZ() << endl;
	//cout << character->position.x << "  " << character->position.z << endl;
